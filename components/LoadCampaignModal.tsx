            ...
            <div className="space-y-3">
              {campaigns.map(c => (
                <div
                  key={c.id}
                  onClick={() => onLoad(c)}
                  className="w-full text-left p-4 bg-gray-900 rounded-md border border-gray-700 hover:bg-gray-700/50 hover:border-indigo-500 transition-all cursor-pointer flex justify-between items-center"
                >
                    <div>
