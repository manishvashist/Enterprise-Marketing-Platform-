                ...
                {isLoading && !mediaPlan ? ( // Initial loading state
                     <div className="w-full h-full flex flex-col items-center justify-center bg-white rounded-lg p-8 border-2 border-dashed border-slate-300 min-h-[300px]">
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold text-slate-800">Generating Your Media Plan...</h3>
                            <p className="text-slate-500 mt-2">The AI is analyzing your campaign context to build a data-driven plan.</p>
                        </div>
                    </div>
                ) : mediaPlan ? (
                    <MediaPlanDisplay 
